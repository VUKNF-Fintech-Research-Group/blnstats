...
class LNResearchData:
    ...
    def push_data_to_main_tables():
        ...
        SELECT 
            LNResearch_20230924_ChannelAnnouncement.short_channel_id,
            LNResearch_20230924_ChannelAnnouncement.blockchain_height,
            LNResearch_20230924_ChannelAnnouncement.blockchain_output_index,
            LNResearch_20230924_ChannelAnnouncement.blockchain_tx_index,
            LNResearch_20230924_ChannelAnnouncement.node_id_1,
            LNResearch_20230924_ChannelAnnouncement.node_id_2
        FROM LNResearch_20230924_ChannelAnnouncement
        '''
