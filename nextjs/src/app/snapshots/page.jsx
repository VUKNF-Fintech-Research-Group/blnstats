...
// Page Components
import SnapshotsPage from "@/systemPages/PublicPages/Snapshots/Snapshots";

// Settings
const THIS_FILE_PATH = "/app/snapshots/page.jsx";
...
export default async function Page() {
  return (
    ...
    >
      {(authData) => <SnapshotsPage authData={authData}/>}
    </EndpointWrapper>
  )
}